...
public class SkillTestCustom extends RootActivity {
...
//              get resource id that will be queried in the drawable resource and set as test image
                ...
                if (resID == 0) {
                    loadImageFromUrl(imageUrl[mCorrectAnswerIndex]);
                } else {
...
//                mCorrectName = arrayListName.get(mCorrectAnswerIndex);
                ...
                if (bool) {
                    Toast.makeText(SkillTestCustom.this, "Correct!", Toast.LENGTH_SHORT).show();
                    mCorrectAnswer = mCorrectAnswer+1;

                }else {
                    Toast.makeText(SkillTestCustom.this, "Wrong! Try again", Toast.LENGTH_SHORT).show();
                }
        ...
        answerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(SkillTestCustom.this, "This is " + mCorrectName, Toast.LENGTH_SHORT).show();
            }
        });
