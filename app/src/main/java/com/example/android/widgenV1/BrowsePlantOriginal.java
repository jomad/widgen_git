...
public class BrowsePlantOriginal extends AppCompatActivity {
...
//                is not present in an array, positive index will tell the position
                ...
                switch (index) {
                    case -1:
                        Toast.makeText(BrowsePlantOriginal.this, "Name not found", Toast.LENGTH_LONG).show();
                        break;
...
/*
                ...
                Intent i = new Intent(BrowsePlantOriginal.this, ZoomedSearchImage.class);
